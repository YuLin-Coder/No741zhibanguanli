			...
			<div class="col-md-1 col-sm-2">
				<div class="btn-group">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li><a href="javascript:void(0)" class="dropOption">值班地址</a></li>
		...
		<div class="row" style="margin-top: 25px">
			<div class="col-md-5">
				<button class="btn btn-sm btn-default" id="add_repository">
					<span class="glyphicon glyphicon-plus"></span> <span>添加值班信息</span>
				</button>
					...
					<div class="col-md-8 col-sm-8">
						<form class="form-horizontal" role="form" id="repository_form"
							...
							<div class="form-group">
								<label for="" class="control-label col-md-4 col-sm-4"> <span>值班地址：</span>
								</label>
								<div class="col-md-8 col-sm-8">
									<input type="text" class="form-control" id="repository_address"
										name="repository_address" placeholder="值班地址">
								</div>
							</div>
							<div class="form-group">
								<label for="" class="control-label col-md-4 col-sm-4"> <span>值班时间：</span>
								</label>
								<div class="col-md-8 col-sm-8">
									<input type="text" class="form-control" id="repository_area"
										name="repository_area" placeholder="值班时间">
								</div>
							</div>
							<div class="form-group">
								<label for="" class="control-label col-md-4 col-sm-4"> <span>值班状态：</span>
								</label>
								<div class="col-md-8 col-sm-8">
									<input type="text" class="form-control" id="repository_status"
										name="repository_status" placeholder="值班状态">
								</div>
							</div>
							<div class="form-group">
								<label for="" class="control-label col-md-4 col-sm-4"> <span>值班描述：</span>
								</label>
								<div class="col-md-8 col-sm-8">
									<textarea class="form-control" id="repository_desc"
										name="repository_desc" placeholder="值班描述" style="min-width: 100%"></textarea>
								</div>
							</div>
						</form>
					</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button class="close" type="button" data-dismiss="modal"
					aria-hidden="true">&times;</button>
				<h4 class="modal-title" id="myModalLabel">导入值班信息</h4>
			</div>
			<div class="modal-body">
				<div id="step1">
					<div class="row" style="margin-top: 15px">
				...
				<div id="step2" class="hide">
					<div class="row" style="margin-top: 15px">
						...
						<div class="col-md-10 col-sm-10">
							<div>
								<h4>请按照值班信息电子表格中指定的格式填写需要添加的一个或多个值班信息</h4>
							</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button class="close" type="button" data-dismiss="modal"
					aria-hidden="true">&times;</button>
				<h4 class="modal-title" id="myModalLabel">导出值班信息</h4>
			</div>
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-8 col-sm-8">
						<h3>是否确认导出值班信息</h3>
						<p>(注意：请确定要导出的值班信息，导出的内容为当前列表的搜索结果)</p>
					</div>
				</div>
			</div>
			<div class="modal-footer">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-8 col-sm-8">
						<h3>是否确认删除该条值班信息</h3>
						<p>(注意：若该值班已经有出入库记录或仓存信息，则该值班信息将不能删除成功。如需删除该值班的信息，请保证该值班没有出入库和仓存信息关联)</p>
					</div>
				</div>
			</div>
			<div class="modal-footer">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button class="close" type="button" data-dismiss="modal"
					aria-hidden="true">&times;</button>
				<h4 class="modal-title" id="myModalLabel">编辑值班信息</h4>
			</div>
			<div class="modal-body">
				<!-- 模态框的内容 -->
				<div class="row">
