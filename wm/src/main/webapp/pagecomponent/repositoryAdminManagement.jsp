		...
		$('#add_modal_submit').click(function() {
			...
			$.ajax({
				...
				success : function(response) {
					...
					if (response.result == "success") {
						type = "success";
						msg = "人员添加成功<br><p>(注意：人员的系统初始密码为该ID)</p>";
					...
					<div class="col-md-2 col-sm-3">
						<div class="btn-group">
							...
							<ul class="dropdown-menu" role="menu">
								<li><a href="javascript:void(0)" class="dropOption">人员ID</a></li>
								<li><a href="javascript:void(0)" class="dropOption">人员姓名</a></li>
								<li><a href="javascript:void(0)" class="dropOption">值班ID</a></li>
		...
		<div class="row" style="margin-top: 25px">
			<div class="col-md-5">
				<button class="btn btn-sm btn-default" id="add_repositoryAdmin">
					<span class="glyphicon glyphicon-plus"></span> <span>添加人员信息</span>
				</button>
					...
					<div class="col-md-8 col-sm-8">
						<form class="form-horizontal" role="form" id="repositoryAdmin_form"
							...
							<div class="form-group">
								<label for="" class="control-label col-md-5 col-sm-5"> <span>人员姓名：</span>
								</label>
								<div class="col-md-7 col-sm-7">
									<input type="text" class="form-control" id="repositoryAdmin_name"
										name="repositoryAdmin_name" placeholder="人员姓名">
								</div>
							</div>
							<div class="form-group">
								<label for="" class="control-label col-md-5 col-sm-5"> <span>人员性别:</span>
								</label>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button class="close" type="button" data-dismiss="modal"
					aria-hidden="true">&times;</button>
				<h4 class="modal-title" id="myModalLabel">导入人员信息</h4>
			</div>
			<div class="modal-body">
				<div id="step1">
					<div class="row" style="margin-top: 15px">
				...
				<div id="step2" class="hide">
					<div class="row" style="margin-top: 15px">
						...
						<div class="col-md-10 col-sm-10">
							<div>
								<h4>请按照人员信息电子表格中指定的格式填写需要添加的一个或多个人员信息</h4>
							</div>
				...
				<div id="step3" class="hide">
					<div class="row" style="margin-top: 15px">
						...
						<div class="col-md-8 col-sm-10">
							<div>
								<div>
									<h4>请点击下面上传文件按钮，上传填写好的人员信息电子表格</h4>
								</div>
								<div style="margin-top: 30px; margin-buttom: 15px">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-8 col-sm-8">
						<h3>是否确认导出人员信息</h3>
						<p>(注意：请确定要导出的人员信息，导出的内容为当前列表的搜索结果)</p>
					</div>
				</div>
			</div>
			<div class="modal-footer">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-8 col-sm-8">
						<h3>是否确认删除该条人员信息</h3>
						<p>(注意：若该人员已经指派管理的值班，则该人员信息将不能删除成功。如需删除该客户的信息，请先解除该人员的指派)</p>
					</div>
				</div>
			</div>
			<div class="modal-footer">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button class="close" type="button" data-dismiss="modal"
					aria-hidden="true">&times;</button>
				<h4 class="modal-title" id="myModalLabel">编辑人员信息</h4>
			</div>
			<div class="modal-body">
				<!-- 模态框的内容 -->
				<div class="row">
					...
					<div class="col-md-8 col-sm-8">
						<form class="form-horizontal" role="form" id="repositoryAdmin_form_edit"
							...
							<div class="form-group">
								<label for="" class="control-label col-md-5 col-sm-5"> <span>所属值班ID：</span>
								</label>
								<div class="col-md-7 col-sm-7">
							...
							<div class="form-group hide" id="repositoryInfo">
								...
								<div class="col-md-10 alert alert-info">
									<div><label>值班地址：</label><span id="repository_address"></span></div>
									<div><label>值班面积：</label><span id="repository_area"></span></div>
									<div><label>值班状态:</label><span id="repository_status"></span></div>
								</div>
							</div>
						</form>
					</div>
