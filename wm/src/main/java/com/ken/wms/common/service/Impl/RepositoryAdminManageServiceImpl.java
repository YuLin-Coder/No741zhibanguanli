...
public class RepositoryAdminManageServiceImpl implements RepositoryAdminManageService {
    ...
    /**
     * 返回指定repository id 的值班管理员记录
     *
     * @param repositoryAdminID 值班管理员ID
    ...
    /**
     * 返回指定 repository address 的值班管理员记录 支持查询分页以及模糊查询
     *
     * @param offset 分页的偏移值
     * @param limit  分页的大小
     * @param name   值班管理员的名称
    ...
    /**
     * 返回指定 repository Name 的值班管理员记录 支持模糊查询
     *
     * @param name 值班管理员名称
     * @return 结果的一个Map，其中： key为 data 的代表记录数据；key 为 total 代表结果记录的数量
     */
     ...
     *
     * @param repositoryAdminID 值班管理员ID
     * @param repositoryID      所指派的值班ID
     * @return 返回一个 boolean 值，值为 true 表示值班指派成功，否则表示失败
     */
    @UserOperation(value = "指派值班管理员")
    @Override
     ...
     *
     * @param repositoryAdmin 值班管理员信息
     * @return 返回一个 boolean 值，若值班管理员信息中要求非空均有值，返回 true，否则返回 false
     */
    ...
    /**
     * 返回所属指定 repositoryID 的值班管理员信息
     *
     * @param repositoryID 值班ID 其中： key为 data 的代表记录数据；key 为 total 代表结果记录的数量
     * @return 返回一个Map，
     */
    @Override
